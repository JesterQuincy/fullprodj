...
class getSecurity_EventDispatcher_ApiService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => #[\Closure(name: 'league.oauth2_server.listener.check_scope', class: 'League\\Bundle\\OAuth2ServerBundle\\Security\\EventListener\\CheckScopeListener')] function () use ($container) {
