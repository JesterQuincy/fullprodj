...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\TaskControllerEmail' => 'getTaskControllerEmailService',
            'App\\Controller\\TaskControllerId' => 'getTaskControllerIdService',
            'App\\Controller\\TaskStatus' => 'getTaskStatusService',
            'App\\Controller\\User\\GetCurrentController' => 'getGetCurrentControllerService',
    ...
    {
        return $this->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Vy80kMprwq', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c = ($this->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([0 => (\dirname(__DIR__, 4).'/src/Entity'), 1 => (\dirname(__DIR__, 4).'/vendor/league/oauth2-server-bundle/src/Entity')]));
        ...
        $a->setEntityNamespaces(['App' => 'App\\Entity', 'LeagueOAuth2ServerBundle' => 'League\\Bundle\\OAuth2ServerBundle\\Entity']);
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('league.oauth2_server.event.user_resolve', [0 => #[\Closure(name: 'App\\EventListener\\UserResolveListener')] function () {
            return ($this->privates['App\\EventListener\\UserResolveListener'] ?? $this->load('getUserResolveListenerService'));
        }, 1 => 'onUserResolve'], 0);
        ...
        $instance->addListener('league.oauth2_server.event.authorization_request_resolve', [0 => #[\Closure(name: 'league.oauth2_server.listener.authorization_request_user_resolving', class: 'League\\Bundle\\OAuth2ServerBundle\\EventListener\\AuthorizationRequestUserResolvingListener')] function () {
        ...
        $instance->addListener('league.oauth2_server.event.pre_save_client', [0 => #[\Closure(name: 'League\\Bundle\\OAuth2ServerBundle\\EventListener\\AddClientDefaultScopesListener')] function () {
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => #[\Closure(name: 'league.oauth2_server.listener.check_scope', class: 'League\\Bundle\\OAuth2ServerBundle\\Security\\EventListener\\CheckScopeListener')] function () {
    ...
    /**
     * Gets the private '.service_locator.sxT5fTp' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_SxT5fTpService()
    {
        return $this->privates['.service_locator.sxT5fTp'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UhnTsV9OcM', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-r0H8KzvUN', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7RW-aL0q92', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EfA0bSa6pr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('p4F+--EfBZ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    {
        $a = ($this->privates['.service_locator.sxT5fTp'] ?? $this->get_ServiceLocator_SxT5fTpService());
        ...
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () {
            yield 'security.firewall.map.context.api_token' => ($this->privates['.security.request_matcher.pu7NcaE'] ?? $this->load('get_Security_RequestMatcher_Pu7NcaEService'));
            yield 'security.firewall.map.context.api' => ($this->privates['.security.request_matcher.yy_ZK6T'] ?? $this->load('get_Security_RequestMatcher_YyZK6TService'));
        }, 2));
    }
    ...
    private function getDynamicParameter(string $name)
    {
        $value = match ($name) {
            ...
            'league.oauth2_server.encryption_key' => $this->getEnv('resolve:OAUTH_ENCRYPTION_KEY'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'api_platform.resource_class_directories' => [
                0 => (\dirname(__DIR__, 4).'/vendor/league/oauth2-server-bundle/src/Entity'),
                1 => (\dirname(__DIR__, 4).'/src/ApiResource'),
                2 => (\dirname(__DIR__, 4).'/src/Entity'),
            ],
            'api_platform.oauth.enabled' => true,
            'api_platform.oauth.clientId' => '53c397a25d6ffca70b8d9b0654923551',
            'api_platform.oauth.clientSecret' => 'd662aea67bcb1099ec55cb09521e433cc3ca0da8802448420c4d5e610a8c56b2052a6696beac02b899a670a94cbfdd29ac61aa0dbfc10f5f6499a3787750fe90',
            'api_platform.oauth.type' => 'oauth2',
            'api_platform.oauth.flow' => 'password',
            'api_platform.oauth.tokenUrl' => '/token',
